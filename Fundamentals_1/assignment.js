...
const agee = 23;
agee >= 18
  ? console.log(`i like to race cars`)
  : console.log(`i like to race bicycles`);
...
console.log(
  `The bill was ${value}, the tip was ${calculatedTip} and the total value ${
    value + calculatedTip
  }`
);
...
if (
  whatToKnow != `friends` &&
  whatToKnow != `firstName` &&
  whatToKnow != `secondName`
) {
...
// fundamentals two coding challenge

// function calcTip(bill) {
//   return bill >= 50 && bill <= 300 ? bill * 0.15 : bill * 0.2;
// }
const billls = [22, 295, 176, 440, 37, 105, 10, 1100, 86, 52];
const tipss = [];
const total = [];
...
console.log(calcAverage([6, 12, 9]));

const measureKelvin = function () {
  const measurement = {
    temp: "temp",
    unit: "celcius",
    value: Number(prompt("Enter degree celcius: ")),
  };
